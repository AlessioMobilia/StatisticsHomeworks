...
namespace Integration
{
    ...
    public class Charts
    {
        ...
        public void DrawHorizzontalRectangles(List<Interval> intervals, Graphics g)
        {
            ...
            foreach (Interval inter in intervals)
            {
                if (inter.start < maxY && inter.end > minY)
                {
                    ...
                    int width =this.viewPort.Width  - inter.value;
                    ...
                    if (inter.end < maxY)
                        ...
                        y = YRefactor(maxY);
                    int x =XRefactor(inter.value * this.maxX/ this.viewPort.Width);
