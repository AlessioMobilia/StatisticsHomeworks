...
namespace NaiveArithmeticMean
{
    ...
    class Statistics
    {
        ...
        public static double KahanSum(List<double> dataset)
        {
            double sum = 0.0;
            double c = 0.0;
            foreach (double f in dataset)
            {
                double y = f - c;
                double t = sum + y;
                c = (t - sum) - y;
        ...
        public static double KahanArithmeticMean(List<double> dataset)
        {
            double sum = KahanSum(dataset);
            return sum / dataset.Count;
        }

        public static double NeumaierSum(List<double> dataset)
        {
            double sum = 0.0;
            double c = 0.0;
        ...
        public static double NeumaierArithmeticMean(List<double> dataset)
        {
            double sum = NeumaierSum(dataset);
            return sum / dataset.Count;
        }
        ...
        public static double NaiveArithmeticMean(List<double> dataset)
        {
            double sum = NaiveSum(dataset);
            return sum / dataset.Count;
        }

        public static double NaiveSum(List<double> dataset)
        {
            double sum = 0;
            foreach (double data in dataset)
            {
